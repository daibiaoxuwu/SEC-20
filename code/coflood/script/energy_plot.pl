{
	...
	print gnuout "set yrange [4:14]\n";
	print gnuout "set ytics 4,2,14\n";
	...
	print gnuout "plot 'lab_data.txt' using 1:2 with linespoints t 'Lab Testbed' lt 7 lw 4 lc rgb 'black' ps 2 pt 4, 'indriya_data.txt' using 1:2 with linespoints t 'Indriya Testbed' lt 4 lw 4 lc rgb 'red' ps 2 pt 8\n";
	close gnuout;
