...
set ytics 1000,200,2200
plot 'lab_data.txt' using 1:3 with linespoints t 'Lab Testbed' lt 7 lw 4 lc rgb 'black' ps 2 pt 4, 'indriya_data.txt' using 1:3 with linespoints t 'Indriya Testbed' lt 4 lw 4 lc rgb 'red' ps 2 pt 8
