{
	...
	print gnuout "set yrange [1000:2000]\n";
	print gnuout "set ytics 1000,200,2000\n";
	...
	print gnuout "plot 'data.txt' using 1:3 with linespoints t 'Lab Testbed' lt 7 lw 4 ps 2 pt 4\n";
	close gnuout;
