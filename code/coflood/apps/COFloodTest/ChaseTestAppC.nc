configuration ChaseTestAppC {
  ...
  ChaseTestC.RadioControl -> ActiveMessageC;
  ChaseTestC.TreeInit -> FloodingTreeC;
  ChaseTestC.TreeInfo -> FloodingTreeC;
  ...
  components new SerialAMSenderC(AM_TREE_BEACON_MSG) as treeSerialSend;
  ...
  ChaseTestC.treeSerialSend -> treeSerialSend;
  ChaseTestC.treeSerialPkt -> treeSerialSend;
#endif
}
