...
\begin{table}[t]
  ...
  \hline
  Eiband~\cite{eiband2017understanding}  & Naked eye & $\times$ & $\times$ & 1m \\
  Kwon~\cite{kwon2013covert}  & Naked eye & $\times$ & $\times$ &-$^{\mathrm{b}}$\\
Schaub~\cite{schaub2012password} & Naked eye & \cmark & $\times$ & -\\
  Maggi~\cite{maggi2011poster}  & Camera & \cmark  & $\times$ &- \\
  \hline
  \hline
