\begin{table*}[t]
    ...
    \begin{tabular}{ccccc}
    \hline
     Reference & Equipment & Training & distance$^{\mathrm{a}}$ \\
    \hline
    Eiband~\cite{eiband2017understanding}  & naked eye & trained & 1 meter \\
    Kwon~\cite{kwon2013covert}  & naked eye & untrained  & Intimate$^{\mathrm{b}}$\\
Schaub~\cite{schaub2012password} & naked eye & untrained & Intimate\\
    Maggi~\cite{maggi2011poster}  & camera & untrained  & Intimate \\
    \hline
    \hline
    \textbf{\textsf{SRPeek}} & COTS smartphones & trained  & 1.8m(traditional)\\
  & & &6m(optical zoom)\\
    \hline
    \multicolumn{5}{l}{$^{\mathrm{a}}$The maximum distance and observing view angle to the victim's screen.}\\

    \multicolumn{5}{l}{$^{\mathrm{b}}$The attacker stands next to or behind the victim.}\\
    \end{tabular}
