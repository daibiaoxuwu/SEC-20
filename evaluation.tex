...
\begin{figure}[!t]
    \centering
    \subfigure{\includegraphics[width=0.36\textwidth]{./pic/data_1.pdf}\label{fig-control-1}}
    \subfigure{\includegraphics[width=0.36\textwidth]{./pic/data_1_2.pdf}\label{fig-control-2}}
    \hfill
...
\begin{figure}[!t]
    \centering
    \subfigure{\includegraphics[width=0.36\textwidth]{./pic/data_2.pdf}\label{fig-random-1}}
    \subfigure{\includegraphics[width=0.36\textwidth]{./pic/data_2_2.pdf}\label{fig-random-2}}
    \hfill
