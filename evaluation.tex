...
\begin{figure*}[!t]
    \centering
    \subfigure[Traditional Lens]{\includegraphics[width=0.24\textwidth]{./pic/data_1.pdf}\label{fig-control}}
    \subfigure[Optical Lens]{\includegraphics[width=0.24\textwidth]{./pic/data_1_2.pdf}\label{fig-control2}}
    \subfigure[Traditional Lens]{\includegraphics[width=0.24\textwidth]{./pic/data_2.pdf}\label{fig-random}}
